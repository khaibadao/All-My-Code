...
/*
	...
	idea: Nếu lương < 6tr -> tăng phụ cấp thêm 15%
	      Nếu Lương 6.000.000 <= Lương <= 15.000.000 -> Phụ cấp tăng 15%
	      Còn lại sẽ tăng 10%
	      
	      Khi đã cộng tiền phụ cấp vào lương, ta sẽ được tiền tổng.
	      Gọi là: Total_salry
	      
	      Nếu total_salary <= 8.000.000 sẽ không bị áp thuế
	      Nếu total_salary > 8.000.000, sẽ phải chịu 10% thuế

...
//	gotoxy(0, 5); SetColor(4); cout << a << " " << b << " " << ket_qua;
    gotoxy(0, 5); SetColor(4);
	cout << ket_qua;
	ANS = ket_qua;
}
...
void check(string a, string b){
	...
	// mong la code ra
	int xau_a = 0, xau_b = 0;
//	gotoxy(0, 4); SetColor(12); cout << a << ' ' << b << " " << var << "(var)";
...
//	gotoxy(0, 7); SetColor(12); cout << xau_a << " " << xau_b;
	reverst(x, n1), reverst(y, n2);
	for(int i = n2 ; i < n1 ; ++i) y[i] = 0;
	gotoxy(0, 5); SetColor(3);
//	for(int i = n1 - 1; i >= 0 ; i--){
//		cout << x[i] << " ";
//	}
//	gotoxy(0, 6); SetColor(6);
//	for(int i = n1 - 1; i >= 0 ; i--){
//		cout << y[i] << " ";
//	}
	for(int i = n1 - 1 ; i >= 0 ; i--){
...
// quy uoc : + 0 chua duoc nhap
//           + 1 chua duoc nhap 
// th nhap so a : gt_a = 0, gt_b = 1;
// th nhap so b : gt_a = 1, gt_b = 0
...
void xet_dau_2(string a, string b){
	if(a[0] == '-' && b[0] == '-') dau_dang_truoc = ' ';// dau dang truoc == ' '
...
//	if(Kiem_tra_Ans) so_dau_tien = ANS;	Kiem_tra_Ans = 0;
...
//		gotoxy(0, 2); cout << ANS.size();
		...
		// khi nhap so b thi ham check so se hoat dong 
//		if(Kiem_tra_Ans) so_tiep_theo = ANS;
        if(gia_tri_b) so_tiep_theo = ANS;
		if(so_tiep_theo[0] == '-') dau_b = '-';
		gotoxy(10, 4); cout << "                                                                                         "; gotoxy(10, 4);
		SetColor(7); SetColor(11); cout << "                   ";
...
int main()
{
	while(1){
		...
		chon_phep_toan();
		nhap_so_thu_hai();
//		gotoxy(0, 5); SetColor(12); cout << so_dau_tien << " " << so_tiep_theo;
...
//		gotoxy(0, 2); SetColor(4); cout << so_dau_tien <<  " " << ANS << " " << so_tiep_theo;
